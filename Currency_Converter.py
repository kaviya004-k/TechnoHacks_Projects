...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Label
        self.intro_label = Label(self, text = 'Welcome to Currency Convertor', bg= 'mediumvioletred', fg = 'white', relief = tk.RAISED, borderwidth = 3)
        self.intro_label.config(font = ('Courier',15,'bold'))

        self.date_label = Label(self, text = f"1 Indian Rupee equals = {self.currency_converter.convert('INR','USD',1)} USD \n Date : {self.currency_converter.data['date']}", 
                                relief = tk.RAISED, borderwidth = 4, bg = "lightgoldenrodyellow")
        self.date_label.config(font = ('Courier',10,'bold'))

        self.intro_label.place(x = 70 , y = 5)
        self.date_label.place(x = 110, y= 50)
        ...
        # Convert button
        self.convert_button = Button(self, text = "Convert", fg = "white", bg ="orangered", command = self.perform) 
